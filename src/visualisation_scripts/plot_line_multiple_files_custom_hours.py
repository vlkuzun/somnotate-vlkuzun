...
def plot_sleep_stages(files, subjects):
    ...
    colors = {
        'wake_percent': '#E69F00',    # Golden yellow for Wake
        'non_rem_percent': '#56B4E9',  # Sky blue for NREM
        'rem_percent': '#CC79A7',      # Pink/magenta for REM
    }
    ...
    ax1.legend(handles=legend_elements, loc='upper right', bbox_to_anchor=(1.0, 1.35),
               ncol=3, frameon=True, 
