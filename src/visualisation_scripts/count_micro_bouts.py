...
def main():
    file_paths = [
        'Z:/volkan/sleep_profile/francesca_sub-010/automated_state_annotationoutput_sub-010_ses-01_recording-01_sr-1hz.csv',
        'Z:/volkan/sleep_profile/francesca_sub-010/sub-010_ses-01_recording-01_data-sleepscore_fp_sr-1hz.csv',
        'Z:/volkan/sleep_profile/francesca_sub-010/sub-010_ses-01_recording-01_data-sleepscore_vu_sr-1hz.csv',
        'Z:/volkan/sleep_profile/francesca_sub-010/sub-010_ses-01_recording-01_export(HBH)_sr-1hz.csv'

    ]
    output_file = 'Z:/volkan/somnotate/figures/bout_duration/micro_bout_bar_charts.png'
