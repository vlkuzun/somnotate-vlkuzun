...
def mat_to_csv(file_paths, output_directory_path, sampling_rate, sleep_stage_resolution):
    ...
    for file_path in file_paths:
        ...
        with h5py.File(file_path, 'r') as raw_data:
            ...
            eeg1_data, emg_data, sleep_stages = None, None, None
            ...
            assert eeg1_flattened.shape == emg_flattened.shape, "The flattened shapes of the EEG and EMG data do not match"
